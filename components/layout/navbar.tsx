			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex h-14 sm:h-16 items-center justify-between">
					...
					<div className="hidden md:flex items-center space-x-3 lg:space-x-4">
						...
						<Button variant="outline" size="sm" className="hidden lg:flex bg-transparent" asChild>
							<Link href="https://www.npmjs.com/package/@drag-ui/drag-ui" target="_blank" rel="noopener noreferrer">
								<span className="mr-2 flex items-center">
									<svg width="18" height="18" viewBox="0 0 18 18" fill="none">
										<rect width="18" height="18" fill="#CB3837" />
										<path
											d="M2 2H16V16H2V2ZM4 14H14V4H4V14ZM6 6H12V12H10V8H8V12H6V6Z"
											fill="white"
										/>
									</svg>
								</span>
